  ...
  return (
    <div className="from-slate-100 to-amber-950 bg-gradient-to-r mt-14">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 place-items-center h-[700px] md:h-[650px] relative pt-10 md:pt-0">
        {/* text section */}
        <div className="px-4 space-y-5 text-center md:px-0 md:text-left">
          <motion.h3
          ...
          >
            Delivering Premium{" "}
            <span className="text-amber-900">Coffee Beans</span> Worldwide
          </motion.h1>
          ...
          >
            We specialize in sourcing, processing, and exporting the finest
            Ethiopian coffee beans.
            <span className="hidden sm:block">And other finest cereals.</span>
          </motion.p>
          ...
          >
            <a href="#coffee">
              <button className="px-3 py-2 text-white rounded-md bg-amber-900">
                Our Coffee
              </button>
            </a>
            <a href="#about">
              <button className="px-3 py-2 bg-transparent border rounded-md border-amber-900 text-amber-900">
                About Us
              </button>
            </a>
          </motion.div>
        ...
        <motion.img
          ...
          src={Bean2}
          alt=""
          className="absolute hidden w-20 rotate-45 md:block bottom-20 left-36 x-10"
        />
        <motion.img
          ...
          src={Bean1}
          alt=""
          className="absolute left-0 hidden w-20 md:block top-14"
        />
        <motion.img
          ...
          src={Bean2}
          alt=""
          className="absolute top-0 right-0 hidden w-20 -rotate-45 md:block"
        />
      </div>
    </div>
  );
